...
const paths={demand:'/opt/data/IITP/기술수요조사서/01_양자내성암호_클라우드_보안_프레임워크_개발.hwpx',planning:'/opt/data/IITP/output/01_기술기획보고서_초안.hwpx',rfp:'/opt/data/IITP/output/01_양자내성암호_클라우드_보안_프레임워크_RFP_초안.hwpx'};
...
const rfp=await load('rfp',paths.rfp),task=generateTask(rfp),taskFile=join(out,'workflow-b-task-explanation.hwpx');
